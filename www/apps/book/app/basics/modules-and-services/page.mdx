...
A module must define a service. A service is a TypeScript or JavaScript class holding methods related to a business logic or commerce functionality. It must 
be defined at the root of your module directory under `service.ts` filename. 
